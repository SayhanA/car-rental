...
const BookingDescription = ({ carInfo }) => {
  return (
    <section className="mx-5">
      <div className="border-border container mx-auto flex justify-between gap-5 rounded-md border p-5 shadow-xl">
        <div className="border-border mb-5 flex w-full gap-5 border-0 border-b pb-5">
          <SecureImage
            image={cardCar}
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="my-3 flex gap-4">
              ...
              <span className="flex items-center gap-2">
                <GiCarDoor className="text-text-lite/70" /> <Text>4 doors</Text>
              </span>
              <span className="flex items-center gap-2">
        ...
        <div className="bg-border/50 w-[250px]"></div>
      </div>
    </section>
  );
};
